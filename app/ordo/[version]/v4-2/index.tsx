...
export default function Formv4_2() {
    ...
    <div>
      <style
        dangerouslySetInnerHTML={{
          __html: `
          #hero-section {
            background-image: url('/images/v4_2/ORO-Desktop.webp');
          }
          @media (max-width: 640px) {
            #hero-section {
              background-image: url('/images/v4_2/ORO-Mobile.webp');
            }
          }
        `,
        }}
      ...
      <section
        id="hero-section"
        className="relative flex flex-col items-center p-2 md:p-0 justify-center overflow-hidden z-0 bg-[#D3CAC0] bg-[url('/images/v4_2/ORO-Desktop.webp')] sm:bg-center bg-top bg-cover bg-no-repeat w-full h-full min-h-screen"
      >
        <div
        ...
        >
          ...
          <div className="w-full">
            ...
            <p
              className={`sm:mb-8 mb-2 sm:mt-6 mt-2 flex items-center sm:text-left text-center sm:max-w-[486px] max-w-full ${
                isDark ? "text-[#f4f0e1]" : "text-[#07242c]"
              }`}
            >
              {redLine ? (
            ...
            <p
              className={`sm:text-base xs:text-xs text-[11px] ml-0 sm:text-left text-center w-full max-w-full sm:max-w-[486px] font-roboto py-2 sm:mb-8 mb-4 uppercase flex xs:gap-0 gap-2 items-center justify-center sm:justify-start`}
              style={{ color: "#c0964b" }}
            >
