...
export default function Formv3() {
  ...
  return (
    <div>
      <section
        id="hero-section"
        className="relative flex flex-col items-center pb-2 pt-0 px-2 md:p-0 md:justify-center justify-start overflow-hidden z-0 bg-[#D3CAC0] w-full h-full min-h-screen bg-none md:bg-[url('/images/v3/ORO-Desktop.webp')] lg:bg-top bg-top bg-cover bg-no-repeat"
      >
        <div className="absolute bottom-0 2xl:right-[0px] xl:right-[-200px] lg:right-[-300px] md:right-[-300px] sm:right-[0px] right-[0px] w-[1000px] lg:w-auto md:flex hidden">
          <Image
            src={"/images/v3/ORO.png"}
        ...
        <div className="absolute lg:w-auto md:hidden block top-0 bg-[url('/images/v3/ORO-Mobile.webp')] bg-top bg-cover bg-no-repeat w-full h-full"/>

        <div
          className={`lg:container mx-auto px-4 md:py-10 pb-10 pt-0 mt-0 relative lg:w-[1080px] w-full`}
        >
          {/* Coluna única centralizada ou duas colunas */}
            {isLogo && (
              <div className="mb-8 flex md:justify-start justify-center mt-0">
                <Image
                  src={"/images/logo-o-resgate-dos-otimistas-white.png"}
                  alt="Logotipo Resgate dos otimistas"
                  width={621}
                  height={181}
                  priority
                  className="object-contain select-none xl:w-[550px] lg:w-[480px] md:w-[480px] sm:w-[450px] min-w-[350px] pointer-events-none"
                  style={{
                    maxWidth: "100%",
                    height: "auto",
                  }}
          ...
          <div className="w-full md:max-w-[350px] md:mt-0 mt-40 lg:min-w-full flex flex-col md:items-start items-center">
            <div className={`mt-8 md:text-left text-center text-[#f4f0e1]`}>
              {!titleRedLine ? (
                ...
                <>
                  <div
                    className={`text-2xl lg:text-5xl max-w-2xl leading-none text-[#f4f0e1]`}
                  >
                    {titleRedLine}
                  </div>
                </>
            ...
            {/* <p className={`text-base lg:text-xl text-left max-w-[486px] text-[#f4f0e1] mb-4`}>
            ...
            <form
              ...
              id="cadastro"
              name={launch}
              className={`w-full space-y-4 md:max-w-[486px] max-w-[420px]`}
            >
              <div>
                <input
                  type="email"
            ...
            <p className={`text-xs mt-8 ml-0 text-center w-full max-w-[420px] lg:max-w-[486px] font-light font-roboto text-white uppercase`}>
              © 2024 . All rights reserved. Política de Privacidade
            </p>
          </div>
