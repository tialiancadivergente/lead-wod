...
export default function Biography() {
	...
	const ButtonParticipate = () => {
		return (
			<button
				...
				className="w-full h-14 font-raleway font-extrabold text-[#FFFFFF] rounded-[8px] px-6 text-base uppercase tracking-wide transition-all hover:brightness-110 border border-solid border-transparent [background:linear-gradient(90deg,_#6F0B08_0%,_#E82223_100%)_padding-box,_linear-gradient(180deg,_rgba(255,98,99,0.25)_0%,_#FF6263_100%)_border-box] md:shadow-[0px_6px_13px_0px_#CC1C1C33,_0px_23px_23px_0px_#CC1C1C2B,_0px_52px_31px_0px_#CC1C1C1A,_0px_93px_37px_0px_#CC1C1C08,_0px_145px_41px_0px_#CC1C1C00]"
			>
	...
	return (
		<section
			className={`md:min-h-[1727px] md:h-[1727px] flex flex-col items-center pb-14 p-4 md:p-0 justify-start overflow-hidden bg-[#031B22] bg-[url('/images/oro/v1/biografia_elton_mobile.webp')] md:bg-[url('/images/oro/v1/biografia_elton.webp')] bg-cover bg-top md:bg-center z-0`}
		>
			<div className="mx-auto sm:px-4 lg:w-[1080px] w-full">
				<div className="mt-[220px] md:mt-24">
					<div className="text-2xl md:text-3xl font-bold uppercase text-[#C0964B] text-left md:text-center">
						Que bom que você não desistiu.
					</div>
					<div className="font-raleway text-[#F4F0E1] text-base text-left md:text-center my-8 max-w-[688px] mx-auto font-extralight">
