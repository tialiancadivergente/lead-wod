  ...
  },
  {
    ...
    title: (
      <p
        className="uppercase font-spectral text-[#D3CAC0] font-extrabold"
      >
        Descubra por que, sempre que você vai avançar na vida, <span className="text-[#C0964B]">acontece algum problema ou imprevisto </span> que te impede de ganhar mais dinheiro.
      </p>
    ),
    text: (
      <p>
        Participe do curso gratuito que já <span className="uppercase font-bold">destravou mais de 2 milhões de pessoas</span> a terem uma vida financeira, de relacionamento e saúde melhores. Cadastre-se abaixo.
      </p>
    ),
  },
];