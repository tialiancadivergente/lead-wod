...
export default function BiographyRamon() {
	return (
		<section
			className={`min-h-[1178px] md:min-h-[893px] flex flex-col items-center pb-14 p-2 md:p-0 justify-start overflow-hidden bg-[#000000] bg-[url('/images/wod/v1/bg_mobile_ramon.webp')] md:bg-[url('/images/oro/v9/bg_bio_ramon_desktop.webp.webp')] bg-contain md:bg-cover bg-top md:bg-center bg-no-repeat z-0`}
		>
