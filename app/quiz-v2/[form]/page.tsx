...
export default function Quiz({ params }: { params: { form: string } }) {
  ...
  useEffect(() => {
    if (_params && _params.form) {
      ...
      if (parts[2] === "V10") {
        ...
        versionsV9.includes(versaoValueWithoutVersion)
      ) {
        let tipoValue = parts[0];
        let versaoValue = parts[1];
        let temperaturaValue = parts[2];
          ...
          <div className="container mx-auto relative h-full px-4">
            <div className="flex flex-col items-center justify-center text-center h-[890px]">
              <div className="w-full mx-auto">
                ...
                <h1 className="text-xl  md:text-5xl font-bold text-[#F89500] -mb-1 md:mb-2 text-center">
                  FALTA APENAS UM PASSO
                </h1>
                <h2 className="text-xl  md:text-5xl font-bold text-[#F89500] mb-4 md:mb-7 text-center">
                ...
                <div
                  className="rounded-lg p-4 md:p-7 mb-6 md:mb-8 border border-white max-w-xl mx-auto"
                  style={{ backgroundColor: "rgba(0, 0, 0, 0.79)" }}
                >
                  <h3
                    className="text-white text-base md:text-lg font-medium mb-4 md:mb-5 text-left"
                    style={{ color: "#fff" }}
                  >
                  ...
                  <div className="grid grid-cols-2 gap-3 md:gap-2 mt-5 md:mt-7">
                    ...
                    <Button
                      ...
                      className={`bg-[#F89500] hover:bg-[#e08600] text-white py-3 md:py-5 text-sm md:text-base ${
                ...
                >
                  <p className="text-white text-base md:text-xl mb-4 md:mb-5 max-w-xl mx-auto">
                    Após responder as questões, toque no botão abaixo para
                    receber o link e materiais do evento:
                  </p>
  ...
  return (
    <div>
      <section
        className={`relative flex items-center justify-center overflow-hidden h-full bg-cover sm:bg-top bg-right-top bg-no-repeat `}				
				style={{ backgroundImage: `url('/images/v4/SplashScreenV4Ligth2.webp')` }}
      >
        {/* Loading overlay */}
        {isLoading && (
          <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
        ...
        <div className="container mx-auto relative h-full px-4">
          <div className="flex flex-col items-center justify-center text-center py-8">
            <div className="w-full max-w-4xl mx-auto">
              ...
              <h1
                className={`text-2xl md:text-5xl font-bold text-[#07242C] -mt-4 mb-1 md:mb-2 text-center ${spectral.className}`}
              >
                FALTA APENAS UM PASSO
              </h1>
              <h2
                className={`text-2xl md:text-5xl font-bold text-[#07242C] mb-4 md:mb-7 text-center ${spectral.className}`}
              >
                PARA GARANTIR SUA VAGA!
              </h2>
              ...
              <p
                className="text-white text-base md:text-lg mb-5 md:mb-7 text-center"
                style={{ color: "#07242C", fontFamily: '"Roboto", Sans-serif' }}
              >
                Para concluir sua inscrição, responda:
              </p>
              ...
              >
                <p
                  className="text-[#07242C] text-xs md:text-sm mb-4 md:mb-5"
                  style={{ fontFamily: '"Roboto", Sans-serif' }}
                >
                ...
                <Button
                  className="text-white w-full max-w-sm py-4 md:py-6 text-sm md:text-base hover:opacity-90 transition-opacity duration-300 rounded-3xl"
                  onClick={() => (window.location.href = getWhatsappUrl())}
                  style={{
                    background:
                      "linear-gradient(96.48deg, #065100 -18.33%, #49E413 159.75%)",
